...
public class Constants {
	...
	public static int GUIAreaHeigh = 30;
	public static int GUIAreaWith = 80;
	public static int GUICFHeigh = 20;
	
	public static int TYPE_SINGLETON = 0;
	public static int TYPE_PARALLEL = 1;
}
